...
- [ ] **Step 2: แก้ receipt format ใน Phase 4 BUILD**
...
- [ ] **Step 3: แก้ Final Receipt section**
...
- [ ] **Step 1: สร้าง hooks/ directory และ session-start.sh**
...
- [ ] **Step 2: ทำให้ script executable**

```bash
chmod +x hooks/session-start.sh
```

- [ ] **Step 3: Verify — รัน script ทดสอบ**
...
- [ ] **Step 3: Verify hooks.json syntax**
...
- [ ] ไม่มีไฟล์อื่นถูกแตะโดยไม่จำเป็น
